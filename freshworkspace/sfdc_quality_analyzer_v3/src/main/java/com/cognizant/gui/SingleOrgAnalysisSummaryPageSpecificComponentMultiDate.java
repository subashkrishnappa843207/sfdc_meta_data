...
public class SingleOrgAnalysisSummaryPageSpecificComponentMultiDate implements Initializable {
	private static final Logger log = Logger.getLogger(SingleOrgAnalysisSummaryPageSpecificComponentMultiDate.class);
